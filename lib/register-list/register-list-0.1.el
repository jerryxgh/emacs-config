...
;; 	(register-list-preserve-pos): Don't eval `force-line'.	Use
...
;; 	current during macro-expansion.
;; 	(register-list): Remove unused arg `reg-alist'.	 Use dolist.  Use a
;; 	closure rather than `(lambda ...).
;; 	(register-list-edit-value): Remove unused var `new-val'.
;; 
;; 2013-08-16  bastien1  <bzg@gnu.org>
;; 
