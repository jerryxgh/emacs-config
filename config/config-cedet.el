...
(require 'semantic/analyze/refs) ; 如果没有这一句, 会有下面的错误： semantic-ia--fast-jump-helper: Symbol's function definition is void: semantic-analyze-tag-references
...
;;(global-srecode-minor-mode 1)
                                        ;(setq srecode-map-load-path (concat emacs-config-dir "/config/srecode/") ;SRecode模板文件的装载路径，全局变量
...
(setq semanticdb-default-save-directory "~/.emacs.d/auto-save-list/.semanticdb" ;设置cache文件的保存位置，不设的话默认是在被分析文件的目录下，每个目录一个
